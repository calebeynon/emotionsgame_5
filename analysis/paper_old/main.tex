...
\begin{document}
	...
	\begin{table}[H]
		...
		\input{../output/tables/contributions_summary_aggregate.tex}
	\end{table}
	...
	\begin{table}[H]
		...
		\input{../output/tables/behavior_summary_aggregate.tex}
	\end{table}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.85\textwidth]{../output/plots/mean_contribution_by_round.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.85\textwidth]{../output/plots/mean_contribution_by_segment.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.85\textwidth]{../output/plots/contribution_cdf_by_treatment.png}
	...
	\begin{table}[H]
		...
		\input{../output/tables/issue_17_sentiment_liar_regression.tex}
	\end{table}
	...
	\begin{table}[H]
		...
		\small
		\input{../output/tables/contributions_summary.tex}
	\end{table}
	...
	\begin{table}[H]
		...
		\small
		\input{../output/tables/behavior_summary.tex}
	\end{table}
