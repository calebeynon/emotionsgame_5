# Purpose: Dot plots of z-scored valence on the Results page by liar/sucker
...
# OUTPUT FILES
LIAR_PLOT <- "results_valence_by_liar_status.png"
SUCKER_PLOT <- "results_valence_by_sucker_status.png"
FIRST_LIAR_PLOT <- "results_valence_by_first_time_liar.png"
FIRST_SUCKER_PLOT <- "results_valence_by_first_time_sucker.png"
