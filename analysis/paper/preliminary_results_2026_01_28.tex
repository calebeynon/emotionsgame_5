% Test: verify GitHub Actions Overleaf sync
...
\begin{document}
	...
	\begin{table}[H]
		...
		\input{tables/contributions_summary_aggregate.tex}
	\end{table}
	...
	\begin{table}[H]
		...
		\input{tables/behavior_summary_aggregate.tex}
	\end{table}
	...
	\begin{table}[H]
		...
		\input{tables/contribution_regression.tex}
	\end{table}
	...
	\begin{table}[H]
		...
		\input{tables/issue_17_sentiment_liar_regression.tex}
	\end{table}
	...
	\begin{table}[H]
		...
		\small
		\input{tables/contributions_summary.tex}
	\end{table}
