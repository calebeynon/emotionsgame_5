...
| 4.2 Regression Analysis | Contribution means by round bucket × treatment, then dynamic Arellano-Bond GMM (issue #57) | `treatment_contribution.tex` (Paan, Overleaf-authored), `dynamic_regression_stata.tex` (Paan's Stata version — 3-col Max/Median/Min deviation spec), `dynamic_regression.tex` (R GMM, 3 specs × 2 treatments) |
